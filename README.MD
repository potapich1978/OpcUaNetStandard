...
Four main event types drive the system:
...
- **BrowseServer** – Enumerates child nodes of a folder with their value data types  
...
## Installation
```xml
<PackageReference Include="Potapich.OpcUaNetStandart" Version="1.3.0" />
```
